...
public class RepackagedLang extends Lang {
    ...
    public static MutableComponent translateDirect(String key, Object... args) {
        ...
        return Component.translatable(RepackagedConstants.MOD_ID + "." + key, args1);
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(RepackagedConstants.MOD_ID);
    }
